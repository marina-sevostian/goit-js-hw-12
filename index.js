import{i as l,S as u}from"./assets/vendor-5ObWk2rO.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(e){if(e.ep)return;e.ep=!0;const o=t(e);fetch(e.href,o)}})();async function f(s){return await fetch(`https://pixabay.com/api/?key=46729875-7729b8e358007a47de817f6d1&q=${s}&image_type=photo&orientation=horizontal&safesearch=true`).then(async r=>{if(!r.ok){if(r.status===404)return[];throw new Error(r.status)}return await r.data}).catch(r=>{loader.classList.replace("loader","hide"),l.error({title:"Error",message:"Error! Sorry, something went wrong. This is an error!",color:"#ef4040",close:!1})})}let d=document.querySelector(".gallery");function m(s){const r=s.map(t=>`<div class="photo">
  ...
  <p class="info-item">Downloads <span class="info-item-num">${t.downloads}</span></p>
     ...
     </div> `).join("");d.insertAdjacentHTML("beforeend",r)}let p=document.querySelector(".gallery");document.querySelector(".search-form-btn");let c=document.querySelector(".search-form"),h=document.querySelector(".search-form-input"),y=new u(".gallery a"),a=document.querySelector(".loader");a.classList.replace("loader","hide");c.addEventListener("submit",async s=>{s.preventDefault();const r=h.value.trim();g(),a.classList.replace("hide","loader"),r!==""?(await f(r).then(t=>{t.hits.length===0&&l.error({title:"Error",message:"Sorry, there are no images matching your search query. Please try again!",color:"#ef4040",close:!1}),m(t.hits),y.refresh(),a.classList.replace("loader","hide")}).catch(t=>{a.classList.replace("loader","hide"),l.error({title:"Error",message:"Error! Sorry, something went wrong. This is an error!",color:"#ef4040",close:!1})}),c.reset()):(a.classList.replace("loader","hide"),l.warning({title:"Caution",message:"You forgot important data! Enter something!",color:"#ffa000",close:!1}))});new u(".gallery a",{captionsData:"alt",captionDelay:250});function g(){p.innerHTML=""}
